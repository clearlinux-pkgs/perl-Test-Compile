...
Requires: perl-Test-Compile-man
...
%package man
Summary: man components for the perl-Test-Compile package.
Group: Default

%description man
man components for the perl-Test-Compile package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Test/Compile.pm
/usr/lib/perl5/site_perl/5.26.1/Test/Compile/Internal.pm
