...
Source0  : https://cpan.metacpan.org/authors/id/E/EG/EGILES/Test-Compile-v2.4.0.tar.gz
...
%prep
%setup -q -n Test-Compile-v2.4.0
cd %{_builddir}/Test-Compile-v2.4.0
...
cp %{_builddir}/Test-Compile-v2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-Compile/ca04e67360ff58b1f1099f198aead90c130ddd4e
if test -f Makefile.PL; then
